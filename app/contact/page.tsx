...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
          ...
          if (res.ok) {
              setStatus('success');
              setFormData({ name: '', email: '', projectType: 'Web Application Development', message: '' }); // Reset form
          } else {
              setStatus('error');
          }
      } catch (error) {
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                ...
                >
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Phone */}
                        <a href="tel:+19395399445" className="group block p-6 bg-slate-900/40 border border-white/5 rounded-2xl hover:border-blue-500/50 hover:bg-slate-900/60 transition-all">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className="p-3 bg-slate-950 rounded-xl border border-slate-800 text-blue-500 group-hover:text-blue-400">
                                        <Phone size={24} />
                                    </div>
                                    <div>
                                        <h3 className="text-white font-bold text-lg">Voice Channel</h3>
                                        <p className="text-slate-400 text-sm">+1 (939) 539-9445</p>
                                    </div>
                                </div>
                    ...
                    {/* Meta Info */}
                    <div className="mt-12 flex flex-col md:flex-row gap-8 text-sm text-slate-500 font-mono">
                        <div className="flex items-center gap-2">
                            <MapPin size={16} className="text-indigo-500" />
                            <span>HQ: Puerto Rico (AST Timezone)</span>
                        </div>
                        <div className="flex items-center gap-2">
                ...
                <motion.div 
                    ...
                    className="relative"
                >
                    <div className="p-8 md:p-10 bg-slate-900 border border-white/10 rounded-3xl shadow-2xl relative overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                            ...
                            <p className="text-center text-xs text-slate-600 mt-4">
                                By clicking submit, you agree to the privacy policy. No spam, ever.
                            </p>
                        </form>
                    </div>
                </motion.div>
